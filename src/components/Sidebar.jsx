    ...
    <div className="w-64 bg-black border-r border-gray-800 flex flex-col">
      ...
      <div>
        <nav className="flex-1">
          <ul>
            <li className="px-4 py-3 text-white font-medium">Dashboard</li>
            <li className="px-4 py-3 text-white font-medium">Analytics</li>
            <li className="px-4 py-3 text-gray-500">Connect</li>
            <li className="px-4 py-3 text-gray-500">Dealroom</li>
            <li className="px-4 py-3 text-gray-500">Profile</li>
            <li className="px-4 py-3 text-gray-500">Settings</li>
          </ul>
        </nav>
      </div>
    </div>
